...
impl CPUState {
    pub fn get_mode(&self) -> CycleMode {
        match self {
            ...
            | CPUState::DummyRead | CPUState::Read | CPUState::Break(3) | CPUState::Break(4) => CycleMode::Read,
            ...
            CPUState::Break(_) | CPUState::PushRegister(_) | CPUState::JumpSubroutine(_) => CycleMode::Push,
        }
    }
}
